...
function formatDateEs(dateString: string) {
  return dateFormatterEs.format(new Date(dateString));
}
...
export async function sendPresupuestoEmail({
  ...
  const availabilityMessage = fechaEvento
    ? `Para asegurar disponibilidad el dia ${formatDateEs(fechaEvento)}, te recomendamos confirmar la reserva cuanto antes.`
    : "Para asegurar disponibilidad en la fecha prevista para tu sesion, te recomendamos confirmar la reserva cuanto antes.";
      ...
      <div style="margin:0;padding:40px 24px;background:#0c0c0c;color:#f4efe7;font-family:Georgia,'Times New Roman',serif;">
        <div style="max-width:640px;margin:0 auto;border:1px solid rgba(255,255,255,0.1);border-radius:28px;padding:40px 32px;background:linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02));">
          ...
          <p style="margin:0 0 24px;font-size:16px;line-height:1.8;color:#d8d1c7;">
            Gracias por tu interes en Lorenzo Bellucci Studio. Hemos preparado una propuesta cuidada para tu proyecto fotografico, con una base clara para avanzar juntos.
          </p>
          ...
          <div style="margin-top:28px;border-top:1px solid rgba(255,255,255,0.08);padding-top:24px;">
            ...
            <p style="margin:0 0 10px;font-size:15px;line-height:1.8;color:#d8d1c7;">Presupuesto orientativo sujeto a confirmacion final.</p>
            <p style="margin:0 0 10px;font-size:15px;line-height:1.8;color:#d8d1c7;">Validez de la propuesta: 15 dias.</p>
            <p style="margin:0;font-size:15px;line-height:1.8;color:#d8d1c7;">La reserva queda confirmada tras la aceptacion y la coordinacion directa con el estudio.</p>
          </div>
