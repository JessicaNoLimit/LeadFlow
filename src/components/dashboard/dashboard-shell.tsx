...
export function DashboardShell({
  ...
  return (
    <div className="dashboard-shell relative min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(215,198,168,0.12),transparent_24%),linear-gradient(180deg,#0a0a0a_0%,#111111_100%)]">
